...
# Load the data
dataFile.SWOW       = './data/processed/SWOWES-UY.R60.csv'
SWOW.R1             = importDataSWOW(dataFile.SWOW,'R1')
...
write.csv(S,'./output/S_SWOWES-UY.RW.A75.R1.csv')
...
write.csv(S,'./output/S_SWOWES-UY.RW.A75.R123.csv')